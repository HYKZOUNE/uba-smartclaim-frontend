...
export default function AboutUBA() {
  const [openIndex, setOpenIndex] = useState(null);

  const FAQ = [
    {
      question: "Qu’est-ce que le service UBA SmartClaim ?",
      answer: `
...
👉 Agence UBA : consultation directe auprès de votre conseiller ou agent UBA SmartClaim.  
Le suivi est sécurisé et transparent pour garantir votre tranquillité.
    ...
    },
    {
      ...
      answer: `
Non, UBA SmartClaim est totalement gratuit pour tous les clients UBA Tchad.  
Il s’agit d’un service inclus dans vos services bancaires afin de résoudre rapidement vos incidents financiers sans coût additionnel.
    ...
    },
    {
      ...
      answer: `
Oui, vous pouvez contacter le centre UBA SmartClaim via Email, SMS ou en agence pour demander une modification ou annulation de votre réclamation.  
...
👉 SeConnecter au plateforme et Remplir les informations avec : 
  ...
  return (
    <>
      ...
      <main className="page-container">
        ...
        {/* FAQ */}
        <div className="mt-20">
          <h2 className="page-title text-red-700 mb-8">FAQ – Questions fréquentes ℹ️ À propos UBA SmartClaim</h2>
